...
parameters=struct('a',5.076,'a2',5.076,'a3',5.076,...
    'd',14.212799999999998,...
    'h',0.004866642699752135,'h2',0.004866642699752135,'h3',0.004866642699752135,...
    'mu',23.58137200467744,'g',5.75e-3,'mx',400*3.6*5.11,'mph',18.396,'eph',0,'eexc',0,'dtn',-17.9/1000,...
    'Nmax',5,'cellnumber',100,'NN',170,'Nk',200,'gammakraw',2.74E-01*0.5,'gamma',1.87E-05);
