...
figure;surf(sqrt(3)*(-floor(parameters.NN/2):floor((parameters.NN-1)/2))/(2*sqrt(parameters.cellnumber)),enlist,squeeze(log(enmap(:,parameters.NN/2,:)))','edgecolor','none');view(2);
xlim([-4,4]);
